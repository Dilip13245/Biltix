...
<div
  ...
  <div>
    <h2>Team Members</h2>
    <p>View project team members and their details</p>
  </div>
    ...
    <div class="row g-4 ">
      <div class="col-12 col-lg-3 col-md-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0s">
        <div class="card h-100 B_shadow">
          <div class="card-body d-flex align-items-center p-md-4">
            <div>
              <div class="small_tXt fw-medium">Total Members</div>
      ...
      <div class="col-12 col-lg-3 col-md-4 col-md-6 col-12 wow fadeInUp" data-wow-delay=".4s">
        <div class="card h-100 B_shadow">
          <div class="card-body d-flex align-items-center p-md-4">
            <div>
              <div class="small_tXt fw-medium">Site Engineers</div>
      ...
      <div class="col-12 col-lg-3 col-md-4 col-md-6 col-12  wow fadeInUp" data-wow-delay=".8s">
        <div class="card h-100 B_shadow">
          <div class="card-body d-flex align-items-center p-md-4">
            <div>
              <div class="small_tXt fw-medium">Contractors</div>
      ...
      <div class="col-12 col-lg-3 col-md-4 col-md-6 col-12  wow fadeInUp" data-wow-delay="1.2s">
        <div class="card h-100 B_shadow">
          <div class="card-body d-flex align-items-center p-md-4">
            <div>
              <div class="small_tXt fw-medium">Consultants</div>
          ...
          <div class="card-body py-md-4 px-0">
            <div class="snag-list">
              <div class="items_listing mb-4 px-md-4 px-2 pt-2">
                <h5 class="fw-semibold black_color">Team Directory</h5>
              </div>
              <!-- ------team-member-item------------ -->
              <div
              ...
              <div
                ...
                <div class="d-flex align-items-center gap-3 align-self-start">
                  ...
                  <div>
                    ...
                    <p class="text-muted small  fs14">Site Supervisor</p>
                    <p class="text-muted small fs12">BuildCorp Construction</p>
                  </div>
                </div>
                <div class="d-flex align-items-center gap-3 align-self-end">
              ...
              <div
                ...
                <div class="d-flex align-items-center gap-3 align-self-start">
                  ...
                  <div>
                    ...
                    <p class="text-muted small  fs14">Safety Officer</p>

  ...
  <div class="container-fluid">
                ...
                <div class="col-12 col-md-4 wow fadeInUp" data-wow-delay="0s">
                    <div class="card h-100 B_shadow">
                        <div class="card-body p-md-4 d-flex flex-column justify-content-between">
                            ...
                            <div class="mb-2 text-muted fw-medium">Project Completion</div>
                            <div>
                ...
                <div class="col-12 col-md-4 wow fadeInUp" data-wow-delay=".4s">
                    <div class="card h-100 B_shadow">
                        <div class="card-body p-md-4 d-flex flex-column justify-content-between">
                            ...
                            <div class="mb-1 text-muted fw-medium">Active Workers</div>
                            <div class="text-muted small black_color fw-normal">+12 from last week</div>
                        </div>
                    </div>
                </div>
                <!-- Days Remaining Card -->
                <div class="col-12 col-md-4  wow fadeInUp" data-wow-delay=".8s">
                    <div class="card h-100 B_shadow">
                        <div class="card-body p-md-4">
                            ...
                            <div class="mb-2 text-muted fw-medium">Days Remaining</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card B_shadow">
                        <div class="card-body p-md-4">
                            <div class="d-flex flex-wrap justify-content-between align-items-start">
                                <div>
                                    <h5 class="fw-semibold  mb-3 mb-md-4 black_color">Project Timeline</h5>
                                    <div class="row gy-3 gx-5">
                                        <div class="col-12 col-md-6">
                                            <div class="mb-2 mb-md-3">
                                                <span class="text-muted small black_color">Project Name</span>
                                                <div class="fw-medium d-flex align-items-center gap-1">
                                                    Urban Sky Towers
                                                    <a href="#" class="text-primary ms-1" title="Edit"><img
                                                            src="{{ asset('assets/images/icons/edit.svg') }}" alt="edit"></a>
                                                </div>
                                            </div>
                                            <div class="mb-2 mb-md-3">
                                                <span class="text-muted small black_color">Company Name</span>
                                            ...
                                            <div class="mb-2 mb-md-3">
                                                <span class="text-muted small black_color">Start Date</span>
                                                <div class="fw-medium">25th May, 2025</div>
                                            </div>
                                            <div class="mb-2 mb-md-3">
                                                <span class="text-muted small black_color">End Date</span>
                                                <div class="fw-medium">8th May, 2026</div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="mb-2 mb-md-3">
                                                <span class="text-muted small black_color">Project Type</span>
                                                <div class="fw-medium d-flex align-items-center gap-1p-md-4">
                                                    Tower
                                                    <a href="#" class="text-primary ms-1" title="Edit"><img
                                                            src="{{ asset('assets/images/icons/edit.svg') }}" alt="edit"></a>
                                            ...
                                            <div class="mb-2 mb-md-3">
                                                <span class="text-muted small black_color">Project Manager</span>
                                                <div class="fw-medium d-flex align-items-center gap-1p-md-4">
                                                    Robert Parker
                                                    <a href="#" class="text-primary ms-1" title="Edit"><img
                                                            src="{{ asset('assets/images/icons/edit.svg') }}" alt="edit"></a>
                                            ...
                                            <div class="mb-2 mb-md-3">
                                                <span class="text-muted small black_color">Site Engineer</span>
                                                <div class="fw-medium d-flex align-items-center gap-1p-md-4">
                                                    Johar Parker
                                                    <a href="#" class="text-primary ms-1" title="Edit"><img
                                                            src="{{ asset('assets/images/icons/edit.svg') }}" alt="edit"></a>
            ...
            <div class="row mt-4 wow fadeInUp" data-wow-delay="1.2s">
                <div class="col-12">
                    <div class="card B_shadow">
                        <div class="card-body p-md-4">
                            <h5 class="fw-semibold  mb-3 mb-md-4 black_color">Project Overview</h5>
                            <div class="mb-2 mb-md-3">
                                <div class="mb-2 d-flex justify-content-between align-items-center gap-2">
                                    <h6 class="text-muted fw-medium">Foundation</h6>
                            ...
                            <div class="mb-2 mb-md-3">
                                <div class="mb-2 d-flex justify-content-between align-items-center gap-2">
                                    <h6 class="text-muted fw-medium">Structure</h6>
                            ...
                            <div class="mb-2 mb-md-3">
                                <div class="mb-2 d-flex justify-content-between align-items-center gap-2">
                                    <h6 class="text-muted fw-medium">Roofing</h6>
                            ...
                            <div class="mb-2 mb-md-3">
                                <div class="mb-2 d-flex justify-content-between align-items-center gap-2">
                                    <h6 class="text-muted fw-medium">Interior</h6>
                            ...
                            <div class="mb-2 mb-md-3">
                                <div class="mb-2 d-flex justify-content-between align-items-center gap-2">
                                    <h6 class="text-muted fw-medium">Finishing</h6>
            ...
            <div class="row mt-4 wow fadeInUp" data-wow-delay="1.3s">
                    ...
                    <div class="card h-100 B_shadow">
                        <div class="card-body p-md-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="fw-semibold black_color mb-0 ">Ongoing Activities</h5>
                                <a href="#" class="text-primary" title="Edit"><img
                                        src="{{ asset('assets/images/icons/edit.svg') }}" alt="edit"></a>
                            </div>
                            <ul class="list-unstyled mb-0">
                                <li class="d-flex align-items-center mb-2">
                                    <span class="me-2" style="color:#F58D2E; font-size:1.2em;">&#9679;</span>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card h-100 B_shadow">
                        <div class="card-body p-md-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="fw-semibold black_color mb-0 ">Manpower & Equipment's</h5>
                                <a href="#" class="text-primary" title="Edit"><img
                                        src="{{ asset('assets/images/icons/edit.svg') }}" alt="edit"></a>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-borderless mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-muted fw-medium">Concrete Mixers</td>
                                            <td class="text-end"><a href="#"
                                        ...
                                        <tr>
                                            <td class="text-muted fw-medium">Cranes</td>
                                            <td class="text-end"><a href="#"
                                                    class="text-primary fw-semibold text-decoration-none">1
                                                    Unit</a>
                                            </td>
                    ...
                    <div class="card B_shadow">
                        <div class="card-body p-md-4">
                            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                                <h5 class="fw-semibold black_color mb-0 ">Safety Category</h5>

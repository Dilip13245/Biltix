          ...
          <div class="col-md-8">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <span id="taskDetailPriority" class="badge">-</span>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="card bg-light">
              <div class="card-body">
                ...
                <span id="taskDetailStatus" class="badge badge2 mb-3">Pending</span>
        ...
        <div class="mt-4">
          ...
          <div id="taskComments">
            <div class="d-flex mb-3">
              <img src="{{ asset('assets/images/icons/avtar.svg') }}" class="rounded-circle me-3" width="40" height="40">

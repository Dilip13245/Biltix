...
return [
    ...
    'subscription' => [
        ...
        'features_retrieved' => 'Subscription features retrieved successfully',
        'feature_accessible' => 'Feature is accessible',
        'feature_not_accessible' => 'Feature is not accessible in your current plan',
        ...
        'team_member_cannot_subscribe' => 'Team members cannot subscribe directly. Please contact your company admin.',
        'plan_not_available' => 'Selected plan is not available',
    ],
    'payment' => [
        'config_retrieved' => 'Payment configuration retrieved successfully',
        'registration_stored' => 'Registration data stored. Please proceed with payment.',
        'registration_expired' => 'Registration session expired. Please try again.',
        'payment_not_completed' => 'Payment was not completed successfully',
        'amount_mismatch' => 'Payment amount does not match',
        'registration_complete' => 'Registration and payment completed successfully! Welcome to Biltix.',

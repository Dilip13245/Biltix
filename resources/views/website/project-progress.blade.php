                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-start">
                                <div class="w-100">
                                    ...
                                    <div class="mt-4 d-flex flex-wrap gap-2">
                                        ...
                                        <button
                                            onclick="window.location.href='/website/project/'+currentProjectId+'/daily-log-role-descriptions'"
                                            class="btn btn-outline-primary d-flex align-items-center gap-2 rounded-5 svg-hover-white">
                ...
                container.innerHTML = `
                    <div class="col-12 text-center py-5">
                        <div class="text-muted">
                            ...
                            <h5>{{ __('messages.no_phases_found') }}</h5>
                        </div>
                    </div>
                `;
                return;
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <style>
                        ...
                        [dir="rtl"] #createPhaseModal input[type="number"],
                        [dir="rtl"] #createPhaseModal input[type="number"].form-control,
                        [dir="rtl"] #createPhaseModal input[type="number"].Input_control {

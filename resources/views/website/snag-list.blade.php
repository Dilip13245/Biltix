            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 col-12 mt-3 mt-md-0">
                ...
                <form class="serchBar position-relative serchBar2 ">
                  <input class="form-control " type="search" placeholder="{{ __('messages.search_snags') }}" aria-label="Search">
              ...
              <div class="items_listing d-flex flex-wrap align-items-start gap-3 mb-4 px-md-4 px-2 pt-2">
                ...
                <div class="flex-grow-1">
                  <div class="d-flex flex-wrap align-items-center gap-2 mb-1">
                    ...
                    <span class="badge badge2">{{ __("messages.high") }} {{ __("messages.priority") }}</span>
              ...
              <div class="items_listing d-flex flex-wrap align-items-start gap-3 mb-4 px-md-4 px-2 pt-2">
                ...
                <div class="flex-grow-1">
                  <div class="d-flex flex-wrap align-items-center gap-2 mb-1">
                    ...
                    <span class="badge badge3">{{ __("messages.medium") }} {{ __("messages.priority") }}</span>
              ...
              <div class="items_listing d-flex flex-wrap align-items-start gap-3 mb-4 px-md-4 px-2 pt-2">
                ...
                <div class="flex-grow-1">
                  <div class="d-flex flex-wrap align-items-center gap-2 mb-1">
                    ...
                    <span class="badge badge1">{{ __("messages.low") }} {{ __("messages.priority") }}</span>
                    <span class="badge badge1">Approved</span>
                  </div>
                  <p class="mb-2 text-muted small">{{ __("messages.minor") }} water drip detected under the sink in the executive
                    bathroom.</p>
                  <div class="d-flex flex-wrap gap-3 text-muted small">

            ...
            try {
                ...
                if (reset) {
                    ...
                    document.getElementById('projectsContainer').innerHTML =
                        '<div class="col-12 text-center py-4"><div class="spinner-border" role="status"></div><div class="mt-2">{{ __('messages.loading_projects') }}...</div></div>';
                }
                            ...
                            <div class="d-flex align-items-start justify-content-between mb-3">
                                ${isCompleted ? 
                                    `<div class="text-decoration-none" style="flex: 1; min-width: 0; padding-right: 12px; cursor: not-allowed;">
                                                                                                                            <h6 class="mb-0 fw-semibold" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${project.project_title}</h6>
                                                                                                                        </div>` :
            ...
            if (createProjectForm) {
                createProjectForm.addEventListener('submit', function(e) {
                    ...
                    if (btn) {
                        btn.disabled = true;
                        btn.innerHTML =
                            '<i class="fas fa-spinner fa-spin me-2"></i>{{ __('messages.creating') }}...';
                    }

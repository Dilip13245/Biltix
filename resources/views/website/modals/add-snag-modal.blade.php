    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addSnagModalLabel">
          <i class="fas fa-exclamation-triangle me-2"></i>{{ __("messages.add_new") }} Snag
        </h5>
      ...
      <div class="modal-body">
        <form id="addSnagForm" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <select class="form-select Input_control" id="priority" name="priority" required>
                <option value="low">{{ __("messages.low") }} {{ __("messages.priority") }}</option>
                <option value="medium" selected>{{ __("messages.medium") }} {{ __("messages.priority") }}</option>
                <option value="high">{{ __("messages.high") }} {{ __("messages.priority") }}</option>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <label for="reportedBy" class="form-label fw-medium">{{ __("messages.reported_by") }}</label>

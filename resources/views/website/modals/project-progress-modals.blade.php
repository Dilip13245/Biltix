        ...
        <div class="modal-content">
            <div class="modal-header">
                <style>
                    ...
                    [dir="rtl"] #manpowerModal input[type="number"],
                    [dir="rtl"] #manpowerModal input[type="number"].form-control,
                    [dir="rtl"] #manpowerModal input[type="number"].Input_control {
                                ...
                                <div class="col-7">
                                    ...
                                    <div class="col-5">
                                        <input type="number" class="form-control Input_control" name="count[]" 
                                            ...
                                            required {{ app()->getLocale() == 'ar' ? 'dir="rtl"' : '' }}>
                                </div>
                                </div>
                            </div>
                        </div>
...
function addManpowerField() {
    ...
    fieldDiv.innerHTML = `
        <div class="row">
            ...
            <div class="col-5">
                <input type="number" class="form-control Input_control" name="count[]" 
                    placeholder="{{ __('messages.count') }}" min="0" max="2147483647" oninput="if(this.value.length > 10) this.value = this.value.slice(0,10);" required {{ app()->getLocale() == 'ar' ? 'dir="rtl"' : '' }}>
            </div>
        </div>
    `;
    container.appendChild(fieldDiv);

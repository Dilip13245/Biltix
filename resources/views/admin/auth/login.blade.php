...
<head>
    ...
    <title>{{ __('messages.admin_panel') }} {{ __('messages.login') }} - Biltix</title>
...
<body>
        ...
        <div class="login-card">
            <div class="login-header">
                <div class="logo">
                    ...
                    <h1 class="logo-title">{{ __('messages.admin_panel') }}</h1>
                    <p class="logo-subtitle">{{ __('messages.riverside_commercial_complex') }}</p>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            btn.disabled = true;
            btnText.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>{{ __("messages.loading") }}...';
        });
